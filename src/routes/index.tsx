...
import avatarMe from "@/assets/avatar-2.jpg";
      ...
      <header className="px-5 pt-12 pb-3 flex items-center gap-3 animate-fade-up">
        <div className="relative">
          ...
          <img
            src={avatarMe}
            alt="Me"
            className="relative h-12 w-12 rounded-full object-cover ring-2 ring-[oklch(0.72_0.22_255)] ring-offset-2 ring-offset-background"
          />
        ...
        <div className="flex-1 min-w-0">
          ...
          <h1 className="text-2xl font-bold flex items-center gap-1.5 leading-tight">
            Prince <Sparkles className="h-5 w-5 text-electric" />
          </h1>
            ...
            <div className="mt-1 flex items-start justify-between gap-3">
              ...
              <div className="relative h-24 w-24 shrink-0 grid place-items-center">
                ...
                <div className="text-center">
                  <div className="text-2xl font-bold text-gradient leading-none">87</div>
      ...
      <section className="px-5 mt-6 animate-fade-up">
        <div className="glass rounded-2xl p-4 flex items-center gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-[11px] text-muted-foreground">Day 4 streak — collect 120 coins</p>
          </div>
